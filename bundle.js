...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = (function (_super) {
	    ...
	    App.prototype.getSmallestViewportDimen = function () {
	    ...
	    App.prototype.componentDidMount = function () {
	        var _this = this;
	        window.addEventListener('resize', function (e) { return _this.handleResize(e); });
	    };
	    App.prototype.handleResize = function (e) {
	    ...
	    App.prototype.render = function () {
	        return (React.createElement("div", null, React.createElement("div", {"id": "page-wrapper"}, React.createElement("h1", {"id": "title"}, "Simon"), React.createElement(Board, {"viewHeight": this.state.viewHeight, "gameState": this.state.gameState, "game": this.game})), React.createElement(Foot, null)));
	    };
	    return App;
	})(React.Component);
	var Board = (function (_super) {
	    ...
	    function Board(props) {
	        ...
	        this.boardFactor = 0.65;
	        this.innerFactor = 0.30;
	        this.buttonColors = (_a = {},
	            _a['green'] = "hsl(130, 70%, 45%)",
	            _a['greenActive'] = "hsl(130, 70%, 70%)",
	            _a['red'] = "hsl(5, 70%, 45%)",
	            _a['redActive'] = "hsl(5, 70%, 70%)",
	            _a['blue'] = "hsl(210, 70%, 45%)",
	            _a['blueActive'] = "hsl(210, 70%, 70%)",
	            _a['yellow'] = "hsl(60, 70%, 45%)",
	            _a['yellowActive'] = "hsl(60, 90%, 75%)",
	            _a
	        );
	        this.gameState = this.props.gameState;
	        var _a;
	    }
	    Board.prototype.getBoardDimens = function () {
	        return {
	            width: this.props.viewHeight * this.boardFactor,
	            height: this.props.viewHeight * this.boardFactor
	        };
	    };
	    Board.prototype.getInnerDimens = function () {
	        var displacement = (this.props.viewHeight * this.boardFactor) / 2
	            - (this.props.viewHeight * this.innerFactor) / 2;
	        var fontEMScale = 30 * (this.props.viewHeight / 949);
	        return {
	    ...
	    Board.prototype.getStatus = function (color) {
	        var returnColor = this.buttonColors[color];
	        if (this.gameState.board[color])
	            returnColor = this.buttonColors[(color + "Active")];
	        return {
	            backgroundColor: returnColor
	        };
	    };
	    Board.prototype.isStrict = function () {
	        var strictColor = "darkred";
	        if (this.gameState.isStrict)
	            strictColor = "red";
	        return {
	    ...
	    Board.prototype.render = function () {
	        var _this = this;
	        return (React.createElement("div", {"id": "board", "style": this.getBoardDimens()}, React.createElement("div", {"className": "color-block", "id": "green", "style": this.getStatus('green'), "onClick": function () { return _this.props.game.playerTest('green'); }}), React.createElement("div", {"className": "color-block", "id": "red", "style": this.getStatus('red'), "onClick": function () { return _this.props.game.playerTest('red'); }}), React.createElement("div", {"className": "color-block", "id": "blue", "style": this.getStatus('blue'), "onClick": function () { return _this.props.game.playerTest('blue'); }}), React.createElement("div", {"className": "color-block", "id": "yellow", "style": this.getStatus('yellow'), "onClick": function () { return _this.props.game.playerTest('yellow'); }}), React.createElement("div", {"id": "inner-circle", "style": this.getInnerDimens()}, React.createElement("div", {"id": "controls"}, React.createElement("span", {"id": "count"}, this.gameState.actionPattern.length), React.createElement("div", null, React.createElement("span", {"id": "start", "onClick": function () { return _this.props.game.startGame(); }}, "Start"), React.createElement("span", {"id": "reset", "onClick": function () { return _this.props.game.reset(); }}, "Reset")), React.createElement("div", null, React.createElement("span", {"id": "strict", "onClick": function () { return _this.props.game.toggleStrict(); }}, React.createElement("span", {"id": "strict-light", "style": this.isStrict()}), "Strict"))))));
	    };
	    return Board;
	})(React.Component);
	var Foot = (function (_super) {
	    ...
	    Foot.prototype.render = function () {
	        return (React.createElement("div", {"id": "foot"}, React.createElement("div", {"id": "foot-text"}, "Created with ♥ by ", React.createElement("a", {"href": "https://github.com/Daynil/"}, "Daynil"), " for ", React.createElement("a", {"href": "http://www.freecodecamp.com/"}, "FCC"), React.createElement("br", null), React.createElement("a", {"id": "gh-link", "href": "https://github.com/Daynil/tictactoe-react"}, React.createElement("i", {"className": "fa fa-github-square fa-lg"}), "Github repo"))));
	    };
	    return Foot;
	})(React.Component);
	var Game = (function () {
	    function Game(refreshState) {
	        this.gameState = {
	            playerAction: false,
	            playerPattern: [],
	            actionPattern: [],
	        ...
	        this.sounds = (_b = {},
	            _b['green'] = new Audio('https://s3.amazonaws.com/freecodecamp/simonSound1.mp3'),
	            _b['red'] = new Audio('https://s3.amazonaws.com/freecodecamp/simonSound2.mp3'),
	            _b['yellow'] = new Audio('https://s3.amazonaws.com/freecodecamp/simonSound3.mp3'),
	            _b['blue'] = new Audio('https://s3.amazonaws.com/freecodecamp/simonSound4.mp3'),
	            _b['mistake'] = new Audio('http://res.cloudinary.com/dz9rf4hwz/video/upload/v1453320543/error_ecvn1v.wav'),
	            _b['win'] = new Audio('http://res.cloudinary.com/dz9rf4hwz/video/upload/v1453358424/winsound_xzwkc6.wav'),
	            _b
	        );
	    ...
	    Game.prototype.playerTest = function (color) {
	        if (!this.gameState.playerAction)
	            return;
	        this.gameState.playerPattern.push(color);
	        var currMove = this.gameState.playerPattern.length - 1;
	    ...
	    Game.prototype.startGame = function () {
	        ...
	        if (this.gameState.actionPattern.length > 0)
	            return;
	        this.nextRound();
	    };
	    Game.prototype.nextRound = function () {
	        var possibleMoves = ['green', 'red', 'yellow', 'blue'];
	        var randomMove = possibleMoves[Math.floor(Math.random() * 4)];
	        this.gameState.actionPattern.push(randomMove);
	        this.playPattern();
	    };
	    Game.prototype.playPattern = function () {
	        var _this = this;
	        var patternIndex = 0;
	        var pattern = this.gameState.actionPattern;
	        var levelSpeed = 1000 - (this.gameState.actionPattern.length * 30);
	        var startPlayback = function () {
	            _this.patternPlayback = window.setInterval(function () {
	                if (patternIndex < pattern.length) {
	                    _this.activate(pattern[patternIndex], true);
	                    patternIndex++;
	                }
	                else {
	                    window.clearInterval(_this.patternPlayback);
	                    _this.gameState.playerAction = true;
	                }
	            }, levelSpeed);
	        };
	        window.setTimeout(startPlayback, this.gameState.actionPattern.length * 30 + 100);
	    };
	    Game.prototype.activate = function (color, playSound) {
	        var _this = this;
	        ...
	        window.setTimeout(function () {
	            _this.gameState.board[color] = !_this.gameState.board[color];
	            _this.refreshState();
	        }, 300);
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "#page-wrapper {\n  min-height: 550px;\n  height: 100vh;\n  width: 100%;\n  margin-top: -40px;\n  margin-bottom: -80px;\n  font: normal 30px \"Open Sans\";\n  background-color: #403e3b;\n  text-align: center; }\n  #page-wrapper #title {\n    color: aliceblue; }\n  #page-wrapper #board {\n    position: relative;\n    border-radius: 50%;\n    overflow: hidden;\n    margin: 0 auto; }\n    #page-wrapper #board .color-block {\n      cursor: pointer;\n      display: inline-block;\n      border-radius: 25px;\n      width: 50%;\n      height: 50%; }\n    #page-wrapper #board #blue {\n      position: relative;\n      bottom: 8px; }\n    #page-wrapper #board #yellow {\n      position: relative;\n      bottom: 8px; }\n    #page-wrapper #board #inner-circle {\n      position: absolute;\n      border-radius: 50%;\n      background-color: #403e3b;\n      font: normal 30px \"Open Sans\";\n      color: aliceblue; }\n      #page-wrapper #board #inner-circle #count {\n        font: normal 1.5em 'Orbitron';\n        color: #c33022;\n        padding: 8px;\n        border: 1px solid #303030;\n        box-shadow: inset 2px 2px 9px 4px #2e2e2e;\n        border-radius: 10px;\n        width: 1.8em;\n        display: inline-block; }\n      #page-wrapper #board #inner-circle #controls {\n        position: relative;\n        top: 1.65em;\n        font-size: 0.7em; }\n        #page-wrapper #board #inner-circle #controls #start {\n          position: relative;\n          top: 2.1em;\n          right: 10px; }\n        #page-wrapper #board #inner-circle #controls #reset {\n          position: relative;\n          top: 2.1em;\n          left: 10px; }\n        #page-wrapper #board #inner-circle #controls #strict-light {\n          display: inline-block;\n          position: relative;\n          bottom: 3px;\n          margin-left: 2px;\n          margin-right: 4px;\n          padding: 5px;\n          border-radius: 50%;\n          background-color: darkred; }\n        #page-wrapper #board #inner-circle #controls #strict {\n          position: relative;\n          top: 4.4em;\n          left: 5px;\n          padding-left: 5px; }\n\n.border-button, #page-wrapper #board #inner-circle #controls #start, #page-wrapper #board #inner-circle #controls #reset, #page-wrapper #board #inner-circle #controls #strict {\n  border: 1px solid aliceblue;\n  border-radius: 5px;\n  padding: 0.4em;\n  cursor: pointer;\n  transition: 0.1s; }\n  .border-button:active, #page-wrapper #board #inner-circle #controls #start:active, #page-wrapper #board #inner-circle #controls #reset:active, #page-wrapper #board #inner-circle #controls #strict:active {\n    color: #403e3b;\n    background-color: aliceblue; }\n\n.no-select, .border-button, #page-wrapper #board #inner-circle #controls #start, #page-wrapper #board #inner-circle #controls #reset, #page-wrapper #board #inner-circle #controls #strict {\n  -webkit-user-select: none;\n  -moz-user-select: none;\n  -ms-user-select: none; }\n\n#foot {\n  font-family: 'Ubuntu';\n  font-size: 18px;\n  background-color: #403e3b;\n  font-family: 'Open Sans';\n  color: aliceblue;\n  line-height: 28px;\n  width: 100%;\n  height: 80px;\n  text-align: center; }\n  #foot #foot-text {\n    position: relative;\n    top: 10px; }\n\n#foot i, #foot a {\n  color: limegreen;\n  transition: 0.6s;\n  text-decoration: none; }\n\n#foot a:hover, #gh-link:hover i {\n  color: aliceblue;\n  text-decoration: none; }\n\n#foot i {\n  padding-right: 2px; }\n", ""]);
